define(['qs', 'lodash'], function (qs, lodash) { 'use strict';
  ...
  // 子名称
  {
    el: $$1('.activity-qrcode__sub-title'),
    field: 'sub_title',
    update(el, value) {
      el.textContent = value;
    }
...
//# sourceMappingURL=activity_qrcode.js.map
